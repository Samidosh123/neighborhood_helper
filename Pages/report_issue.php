...
include '../includes/ai_categorizer.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 🧠 AI predicts category (returns category ID directly)
    $category_id = categorizeIssue($title, $description);
    ...
    if ($stmt->execute()) {
        $message = "✅ Issue reported successfully (AI Category ID: $category_id)";
    } else {
